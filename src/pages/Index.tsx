  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
        ...
        <div className="absolute top-10 right-10 opacity-20 animate-bounce">
          <img
            ...
            alt="Headphones"
            className="w-32 h-32 rounded-full shadow-2xl filter grayscale"
          />
        </div>
        ...
        <div className="absolute bottom-20 left-10 opacity-20 animate-pulse">
          <img
            ...
            alt="Smart watch"
            className="w-24 h-24 rounded-full shadow-2xl filter grayscale"
          />
        </div>
        
        <div className="absolute top-1/2 right-1/4 opacity-15 animate-float">
          <img
            src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=200&h=200&fit=crop"
            alt="Leather bag"
            className="w-28 h-28 rounded-full shadow-2xl filter grayscale"
          />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/products">
                <Button size="lg" className="bg-white text-black hover:bg-gray-100 font-semibold transform hover:scale-105 transition-all">
                  Shop Now
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/about">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-black transform hover:scale-105 transition-all">
                  Learn More
                </Button>
              </Link>
            </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-gray-50 dark:from-gray-900 to-transparent">
          <div className="flex justify-center items-end space-x-8 h-full pb-4 opacity-60">
            <img
              ...
              alt="Sunglasses"
              className="w-16 h-16 rounded-lg shadow-lg filter grayscale"
            />
            <img
              src="https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=100&h=100&fit=crop"
              alt="Keyboard"
              className="w-20 h-20 rounded-lg shadow-lg filter grayscale"
            />
            <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              <TrendingUp className="h-8 w-8 text-black dark:text-white mx-auto" />
              <div className="text-3xl font-bold text-gray-900 dark:text-white">50K+</div>
              <div className="text-gray-600 dark:text-gray-400">Happy Customers</div>
            </div>
            <div className="space-y-2">
              <Award className="h-8 w-8 text-black dark:text-white mx-auto" />
              <div className="text-3xl font-bold text-gray-900 dark:text-white">1000+</div>
              <div className="text-gray-600 dark:text-gray-400">Premium Products</div>
            </div>
            <div className="space-y-2">
              <ShoppingCart className="h-8 w-8 text-black dark:text-white mx-auto" />
              <div className="text-3xl font-bold text-gray-900 dark:text-white">24/7</div>
              <div className="text-gray-600 dark:text-gray-400">Fast Delivery</div>
            </div>
            <div className="space-y-2">
              <Star className="h-8 w-8 text-black dark:text-white mx-auto" />
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">Discover our hand-picked selection of premium items</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProducts.map((product) => (
              <Card key={product.id} className="group hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <div className="relative overflow-hidden">
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500 filter grayscale"
                  />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Link to={`/products/${product.id}`}>
                        <Button variant="outline" size="sm" className="hover:scale-105 transition-transform border-gray-300 dark:border-gray-600">View</Button>
                      </Link>
                      <Button 
                        size="sm" 
                        onClick={() => handleAddToCart(product)}
                        className="bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 hover:scale-105 transition-transform"
                      >
          ...
          <div className="text-center mt-12">
            <Link to="/products">
              <Button size="lg" className="bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 transform hover:scale-105 transition-all">
                View All Products
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
      ...
      <section className="py-16 bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why Choose EliteShop?</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">Experience the difference with our premium service</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 group">
              <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-colors">
                <ShoppingCart className="h-8 w-8 text-black dark:text-white" />
              </div>
